/**
 * @generated SignedSource<<b6c00b9757c1dacd7159c5f1fb3b3b60>>
...
export type RepositoryListFragmentQuery$variables = {
  after?: string | null;
  first?: number | null;
  id: string;
};
export type RepositoryListFragmentQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"RepositoryListFragment_user">;
  } | null;
};
export type RepositoryListFragmentQuery = {
  response: RepositoryListFragmentQuery$data;
  variables: RepositoryListFragmentQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "RepositoryListFragmentQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
